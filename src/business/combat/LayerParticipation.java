...
public class LayerParticipation {
     ...
     *
     * <b>An unscouted foreign fleet always reads as able to land, and that is correct behaviour.</b>
     * Transport capacity comes from {@code ;TTT;}, which the placeholder troop types do not carry,
     * so such a fleet reads capacity zero, i.e. "the troops are not aboard". That is not a bug to
     * patch around: the placeholder pair IS the input the player was given, the simulator answers
     * faithfully for the input it holds, and a player who needs the real answer scouts the army or
     * types what he thinks is there. Inventing a third "cannot tell" state here would editorialise
     * about the player's intelligence, which is the game itself.
     */
