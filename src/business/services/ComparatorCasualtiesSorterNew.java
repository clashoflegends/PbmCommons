 ...
 * @author jmoura
 */
public class ComparatorCasualtiesSorterNew implements Comparator {

    private static final Log log = LogFactory.getLog(ComparatorCasualtiesSorterNew.class);
    ...
    /*
     ...
     Slow	1	10	
     */
    public ComparatorCasualtiesSorterNew(int aTatica, Terreno aTerreno) {
        this.tatica = aTatica;
