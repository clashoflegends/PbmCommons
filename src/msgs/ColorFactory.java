...
//                    rgb = nacaoCor.getRGB();
    ...
    public static Color getNacaoColorFill(String name) {
        if (name.equals("")) {
            return Color.BLACK;
        } else if (name.equals("")) {
            return Color.BLACK;
    ...
    /*
     @DB.NACAO.NOME.ANOES#
     @DB.NACAO.NOME.ARRYN#
     @DB.NACAO.NOME.ARTHEDAIN#
     @DB.NACAO.NOME.ATENAS#
     @DB.NACAO.NOME.BARATHEON#
     @DB.NACAO.NOME.BARBARIANS#
     @DB.NACAO.NOME.BOLTON#
     @DB.NACAO.NOME.BRAAVOS#
     @DB.NACAO.NOME.CAPITAES.NEGROS#
     @DB.NACAO.NOME.CARDOLAN#
     @DB.NACAO.NOME.CAVALEIRO.SOLITARIO#
     @DB.NACAO.NOME.CORENAR#
     @DB.NACAO.NOME.CORSARIOS#
     @DB.NACAO.NOME.DUNLENDINGS#
     @DB.NACAO.NOME.EASTERLINGS#
     @DB.NACAO.NOME.ELFOS.NOLDOR#
     @DB.NACAO.NOME.ELFOS.SINDAR#
     @DB.NACAO.NOME.ENDERBY#
     @DB.NACAO.NOME.EOTHRAIM#
     @DB.NACAO.NOME.EPIRUS#
     @DB.NACAO.NOME.ESPARTA#
     @DB.NACAO.NOME.FEITICEIRO.CEGO#
     @DB.NACAO.NOME.FREECITIES#
     @DB.NACAO.NOME.FREY#
     @DB.NACAO.NOME.FRUSODIAN#
     @DB.NACAO.NOME.GALATI#
     @DB.NACAO.NOME.GONDOR.DO.NORTE#
     @DB.NACAO.NOME.GONDOR.DO.SUL#
     @DB.NACAO.NOME.GREYJOY#
     @DB.NACAO.NOME.HARADWAITH#
     @DB.NACAO.NOME.HIGHTOWER#
     @DB.NACAO.NOME.HOMENS.DA.FLORESTA#
     @DB.NACAO.NOME.HOMENS.DO.NORTE#
     ...
     @DB.NACAO.NOME.MORCIA#
     @DB.NACAO.NOME.NEUTRAL1#
     @DB.NACAO.NOME.NIGHTWATCH#
     @DB.NACAO.NOME.PENTOS#
     @DB.NACAO.NOME.PERSIA#
     @DB.NACAO.NOME.QYR#
     @DB.NACAO.NOME.RASTONY#
     @DB.NACAO.NOME.RATOS#
     @DB.NACAO.NOME.REIBRUXO#
     @DB.NACAO.NOME.REIFOGO#
     @DB.NACAO.NOME.REIGELO#
     @DB.NACAO.NOME.RHUDAUR#
     @DB.NACAO.NOME.ROYAL.ARMY#
     @DB.NACAO.NOME.SAPOS#
     @DB.NACAO.NOME.SENHOR.DA.NEVOA#
     @DB.NACAO.NOME.SENHOR.DOS.CAES#
     @DB.NACAO.NOME.SENHOR.DOS.DRAGOES#
     @DB.NACAO.NOME.SODALIA#
     @DB.NACAO.NOME.STARK#
     @DB.NACAO.NOME.STORMEND#
     @DB.NACAO.NOME.TARGARYEN#
     @DB.NACAO.NOME.THE.CHURCH#
     @DB.NACAO.NOME.TRACIA#
     @DB.NACAO.NOME.TULLY#
     @DB.NACAO.NOME.TWAINEK#
     @DB.NACAO.NOME.TYRELL#
     @DB.NACAO.NOME.VINGADORA.SILENCIOSA#
