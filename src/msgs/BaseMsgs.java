...
public final class BaseMsgs {
    ...
    public static final String[][] taticas = {{labels.getString("CARGA"), "ca"}, {labels.getString("FLANCO"), "fl"}, {labels.getString("PADRAO"), "pa"}, {labels.getString("CERCO"), "ce"}, {labels.getString("GUERRILHA"), "gu"}, {labels.getString("EMBOSCADA"), "em"}};
