...
public final class BaseMsgs {
    ...
    public static final String[] taticasLabel = {labels.getString("CARGA"), labels.getString("FLANCO"), labels.getString("PADRAO"), labels.getString("CERCO"), labels.getString("GUERRILHA"), labels.getString("EMBOSCADA"), labels.getString("TACTIC.BARRAGEM"), labels.getString("TACTIC.SHIELDWALL"), labels.getString("TACTIC.STANDFIRM"), labels.getString("TACTIC.SWARM")};
